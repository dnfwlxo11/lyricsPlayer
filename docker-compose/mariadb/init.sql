...
-- 뮤지션 추가
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Cole Powell', '/cover/alwayseverbe_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Color Out', '/cover/alone_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Dylan Emmet', '/cover/somethingsdontchange_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Kavi Jezzie Hockaday', '/cover/everyonewillfalldown_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('MODUS', '/cover/mylove_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Nick Ray', '/cover/treadlightly_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Niwel', '/cover/leavemeagain_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('RYYZN', '/cover/secrets_cover.jpg');
INSERT INTO tb_musicians(musician_name, thumbnail_path) VALUES ('Vince Miranda', '/cover/masalla_cover.jpg');

INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Cole Powell 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Cole Powell'), '/cover/alwayseverbe_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Color Out 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Color Out'), '/cover/alone_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Dylan Emmet 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Dylan Emmet'), '/cover/somethingsdontchange_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Kavi Jezzie Hockaday 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Kavi Jezzie Hockaday'), '/cover/everyonewillfalldown_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('MODUS 1집', (SELECT mid FROM tb_musicians WHERE musician_name='MODUS'), '/cover/mylove_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Nick Ray 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Nick Ray'), '/cover/treadlightly_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Niwel 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Niwel'), '/cover/leavemeagain_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('RYYZN 1집', (SELECT mid FROM tb_musicians WHERE musician_name='RYYZN'), '/cover/secrets_cover.jpg');
INSERT INTO tb_albums(album_name, tb_musicians_mid, thumbnail_path) VALUES ('Vince Miranda 1집', (SELECT mid FROM tb_musicians WHERE musician_name='Vince Miranda'), '/cover/masalla_cover.jpg');

-- 앨범 및 노래 추가 --
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Always Ever Be', '161', '/cover/alwayseverbe_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Cole Powell 1집'), 'Cole Powell 1집', 'So, here we sit again \
...
I\'ll write you to show you you\'ll \
Always ever be my love');
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Not the One to Say I Told You So', '236', '/cover/nottheonetosay_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Cole Powell 1집'), 'Cole Powell 1집', 'You wake up this morning, rain is falling \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Alone', '236', '/cover/alone_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Color Out 1집'), 'Color Out 1집', 'This place \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Some Things Dont Change', '203', '/cover/somethingsdontchange_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Dylan Emmet 1집'), 'Dylan Emmet 1집', 'Waking up this morning \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Dont Throw Your Light Away', '183', '/cover/dontthrowyourlightaway_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Kavi Jezzie Hockaday 1집'), 'Kavi Jezzie Hockaday 1집', 'The hardest thing is falling \
...
Freedom is just a calling \
That\'s all you need to know');
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Everyone Will Fall Down', '260', '/cover/everyonewillfalldown_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Kavi Jezzie Hockaday 1집'), 'Kavi Jezzie Hockaday 1집', 'Fall down \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('My Love', '234', '/cover/mylove_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='MODUS 1집'), 'MODUS 1집', 'My every single breath is based on you \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Tread Lightly', '189', '/cover/treadlightly_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Nick Ray 1집'), 'Nick Ray 1집', 'Take a look inside my head to see what troubles me, \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Leave Me Again', '229', '/cover/leavemeagain_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Niwel 1집'), 'Niwel 1집', 'I\'m still alone \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Passionate Affair', '147', '/cover/passionateaffair_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='RYYZN 1집'), 'RYYZN 1집', 'Take my hand you\'ll be okay \
...
Maybe we\'ll go there \
Passionate affair');
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Secrets', '163', '/cover/secrets_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='RYYZN 1집'), 'RYYZN 1집', 'I\'ll never tell \
Never tell \
Just trust \
...
INSERT INTO tb_songs(song_name, playtime, thumbnail_path, tb_albums_aid, album, lyrics) VALUES ('Mas Alla', '244', '/cover/masalla_cover.jpg', (SELECT aid FROM tb_albums WHERE album_name='Vince Miranda 1집'), 'Vince Miranda 1집', 'Hear the cry of your will \
